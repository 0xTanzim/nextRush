...
| A2 — Tier-2 middleware/ext/stream (19) | A | `waves/wave-a2-tier2-middleware.md` | §4 | §0.6 | 🟡 in-progress (8/19: cors·helmet·body-parser·validation·csrf·rate-limit·cookies·compression ✅) |
