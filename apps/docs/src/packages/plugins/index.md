---
title: Plugins
description: Extend NextRush applications with powerful, production-ready features - template engines, logging, static files, and more.
---
...
// Use as plugin (controllers) - auto-discovers @Controller classes
await app.pluginAsync(
  controllersPlugin({
    router,
    root: './src',    // Scan for controllers
    prefix: '/api',
    debug: true,
  })
);
