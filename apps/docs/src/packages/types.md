...
description: Shared TypeScript type definitions for the NextRush framework - the single source of truth for all types.
---
...
flowchart TB
    ...
    subgraph Consumers["Package Consumers"]
        ...
        PLUGINS["@nextrush/plugins"]
        APP["Your App"]
    end

    Types --> Consumers

    style Types fill:transparent,stroke:#8b5cf6,stroke-width:2px
    style Consumers fill:transparent,stroke:#6366f1,stroke-width:2px,stroke-dasharray:5 5
```
