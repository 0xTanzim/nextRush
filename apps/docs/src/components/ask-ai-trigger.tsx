 ...
 * Every result is a real excerpt from a real page in `apps/docs/content/docs/**`, ranked by
 ...
 * same function `llms-full.txt` uses). See `apps/docs/src/lib/ask-ai-search.ts` for the
 * retrieval logic and `apps/docs/src/app/ask-ai-index.json/route.ts` for the index.
 */
  ...
  return (
    <Popover>
      <PopoverTrigger
        ...
        aria-label="Ask AI"
        className="inline-flex items-center gap-1.5 rounded-md px-2 py-1 text-sm font-medium text-fd-muted-foreground transition-colors hover:text-fd-foreground"
      >
