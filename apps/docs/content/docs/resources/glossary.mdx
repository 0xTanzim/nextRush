...
See [Plugins](/docs/concepts/plugins).
...
See [Routing](/docs/concepts/routing) and [Internals: Router](/docs/internals) for the design.
...
packages (both now deprecated compatibility shims) and re-exports a subset of `@nextrush/di`
