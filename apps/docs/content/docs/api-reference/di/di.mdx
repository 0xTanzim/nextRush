...
1. **Enhanced error messages** — resolution failures include the full dependency chain, the missing token, and concrete fix suggestions.
2. **Circular dependency detection** — caught at resolution time with cycle visualization.
...
<TypeTable
  ...
  types={{
    ...
    DependencyResolutionError: {
      type: 'DIError',
      description:
        'Token not registered and cannot be resolved. Includes chain and missingDependency properties.',
    },
    CircularDependencyError: {
      type: 'DIError',
      description: 'Circular dependency detected during resolution. Includes cycle property.',
    },
    MissingDependencyError: {
      type: 'DIError',
      description: 'Required dependency not found. Includes token property.',
    },
