...
| [@nextrush/csrf](/docs/api-reference/middleware/csrf)               | CSRF protection       | Form/session security  |
| [@nextrush/body-parser](/docs/api-reference/middleware/body-parser) | Request body parsing  | JSON/form APIs         |
| [@nextrush/multipart](/docs/api-reference/middleware/multipart)     | File upload parsing   | Multipart form uploads |
| [@nextrush/validation](/docs/api-reference/middleware/validation)   | Request validation    | Zod/Valibot/ArkType schemas |
...
- [CSRF](/docs/api-reference/middleware/csrf) — Protect against cross-site request forgery
- [Body Parser](/docs/api-reference/middleware/body-parser) — Parse request bodies
- [Multipart](/docs/api-reference/middleware/multipart) — Parse file uploads
- [Validation](/docs/api-reference/middleware/validation) — Validate requests with Zod/Valibot/ArkType
