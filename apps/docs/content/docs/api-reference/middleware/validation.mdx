...
- **Body parsing** — that is [`@nextrush/body-parser`](/docs/api-reference/middleware/body-parser)'s job.
- **Response validation** — planned alongside `@nextrush/openapi`.

## Related

- [`@nextrush/openapi`](/docs/api-reference/plugins/openapi) — reads the schemas this middleware contributes to route metadata and renders them as a spec
- [`@nextrush/body-parser`](/docs/api-reference/middleware/body-parser) — populates `ctx.body` before validation runs
