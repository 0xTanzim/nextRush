...
- [`@nextrush/core`](/docs/api-reference/core/core) — Application and middleware
- [`@nextrush/router`](/docs/api-reference/core/router) — Routing
- [`@nextrush/adapter-node`](/docs/api-reference/adapters/node) — Node.js adapter
- [`@nextrush/errors`](/docs/api-reference/core/errors) — HTTP errors
