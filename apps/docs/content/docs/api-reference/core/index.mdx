...
| -------------------------------------------------- | ----------------------------------- | ---------- |
| [`nextrush`](/docs/api-reference/core/nextrush)         | Meta package with all essentials    | Re-exports |
| [`@nextrush/core`](/docs/api-reference/core/core)       | Application, middleware composition | ~500 LOC   |
| [`@nextrush/router`](/docs/api-reference/core/router)   | Segment trie routing                | ~600 LOC   |
| [`@nextrush/types`](/docs/api-reference/core/types)     | TypeScript type definitions         | ~400 LOC   |
| [`@nextrush/errors`](/docs/api-reference/core/errors)   | HTTP error classes                  | ~300 LOC   |
| [`@nextrush/runtime`](/docs/api-reference/core/runtime) | Runtime detection                   | ~400 LOC   |
| [`@nextrush/dev`](/docs/api-reference/core/dev)         | Development server & build tools    | ~800 LOC   |
...
[`nextrush`](/docs/api-reference/core/nextrush) bundles the essentials:
...
[`@nextrush/dev`](/docs/api-reference/core/dev) provides development tooling:
...
<Cards>
  <Card title="nextrush" href="/docs/api-reference/core/nextrush">
  ...
  <Card title="@nextrush/runtime" href="/docs/api-reference/core/runtime">
    Runtime detection and abstractions.
  </Card>
  <Card title="@nextrush/dev" href="/docs/api-reference/core/dev">
