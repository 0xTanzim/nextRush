...
<Cards>
  ...
  />
  <Card title="Adapters" description="Node.js, Bun, Deno, Edge" href="/docs/packages/adapters" />
  <Card
    title="Middleware"
  ...
  />
  <Card title="Tooling" description="nextrush meta package, dev tools" href="/docs/packages/core" />
</Cards>
