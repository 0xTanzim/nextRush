...
<Callout type="info" title="Tiered limits by plan">
  ...
  [rate-limit reference](/docs/reference/middleware/rate-limit) for `TieredRateLimitOptions`.
</Callout>
...
- [JWT Authentication (Functional)](/docs/recipes/jwt-authentication) — populate `ctx.state.user` before this recipe
- [Middleware](/docs/concepts/middleware) — execution order and `ctx.next()`
- [Rate Limiting reference](/docs/reference/middleware/rate-limit) — full `RateLimitOptions`
