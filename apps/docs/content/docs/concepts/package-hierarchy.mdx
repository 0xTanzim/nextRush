...
<Cards>
  ...
  />
  <Card title="Adapters" description="Node.js, Bun, Deno, Edge" href="/docs/api-reference/adapters" />
  <Card
    title="Middleware"
  ...
  />
  <Card title="Tooling" description="nextrush meta package, dev tools" href="/docs/api-reference/core" />
</Cards>
