...
### Extensions & Registrars Layer

Extended functionality — mostly middleware, plus a few registrars (`registerControllers`) and one Extension (`events`):
...
### 6. Extensions and registrars can depend on multiple packages
