...
```typescript
import { compose, type ComposeOptions } from '@nextrush/core';
...
<Cards>
  ...
  <Card title="@nextrush/core API" href="/docs/api-reference/core">
    Full compose() and Application API reference.
  </Card>
  <Card title="Middleware Packages" href="/docs/api-reference">
