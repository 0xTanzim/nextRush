...
For class-based controllers (registered via `registerControllers()` from `@nextrush/controllers` / `nextrush/class`), the handler building pipeline adds steps before calling your method:
...
- Learn how [middleware composition](/docs/concepts/middleware-internals) works in detail
- See how NextRush achieves [runtime compatibility](/docs/concepts/runtime-compatibility)
- Explore the [package hierarchy](/docs/concepts/package-hierarchy)
