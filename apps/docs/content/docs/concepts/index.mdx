---
title: Core Concepts
description: The mental models that make NextRush predictable and powerful
---

# Core Concepts

Before you write a single line of code, understand how NextRush thinks.

These aren't just API features—they're the architectural decisions that determine how your application behaves at scale.
...
<Callout type="tip" title="You Can Mix Styles">
...
<Steps>
  <Step>
    ### Context API
    Understand the `ctx` object—it's your primary interface for everything.
    [Read Context →](/docs/concepts/context)
  </Step>
  <Step>
    ### Middleware
    Learn the onion model. It determines execution order and error handling.
    [Read Middleware →](/docs/concepts/middleware)
  </Step>
  <Step>
    ### Routing
    Map URLs to handlers efficiently with radix tree routing.
    [Read Routing →](/docs/concepts/routing)
  </Step>
</Steps>
