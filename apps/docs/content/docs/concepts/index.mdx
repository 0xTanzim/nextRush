...
<Steps>
  <Step>
    ### Context API Understand the `ctx` object—it's your primary interface for everything. [Read
    Context →](/docs/concepts/context)
  </Step>
  <Step>
    ### Middleware Learn the onion model. It determines execution order and error handling. [Read
    Middleware →](/docs/concepts/middleware)
  </Step>
  <Step>
    ### Routing Map URLs to handlers efficiently with radix tree routing. [Read Routing
