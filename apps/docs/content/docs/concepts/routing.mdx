...
<Cards>
  ...
  <Card title="@nextrush/validation" href="/docs/reference/middleware/validation">
    The middleware that contributes request schemas to route metadata.
  </Card>
  <Card title="@nextrush/openapi" href="/docs/reference/plugins/openapi">
    Generates an OpenAPI 3.1 document from route metadata.
  </Card>
  <Card title="@nextrush/router API" href="/docs/reference/core/router">
