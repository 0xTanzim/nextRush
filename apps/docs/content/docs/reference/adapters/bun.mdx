...
- [Adapters Overview](/docs/reference/adapters) — Understanding runtime adapters
- [@nextrush/adapter-node](/docs/reference/adapters/node) — Node.js adapter
- [@nextrush/adapter-edge](/docs/reference/adapters/edge) — Edge runtime adapter
- [@nextrush/runtime](/docs/reference/core/runtime) — Runtime detection utilities
