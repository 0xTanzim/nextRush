...
| [`@nextrush/adapter-bun`](/docs/reference/adapters/bun)   | Bun                       | Yes                    |
| [`@nextrush/adapter-deno`](/docs/reference/adapters/deno) | Deno                      | Yes                    |
| [`@nextrush/adapter-edge`](/docs/reference/adapters/edge) | Edge (Cloudflare, Vercel) | Yes                    |
...
<Cards>
  <Card title="@nextrush/adapter-node" href="/docs/reference/adapters/node">
  ...
  <Card title="@nextrush/adapter-deno" href="/docs/reference/adapters/deno">
    Deno runtime adapter with TypeScript-first support.
  </Card>
  <Card title="@nextrush/adapter-edge" href="/docs/reference/adapters/edge">
