...
<Callout type="warn" title="No VERSION export">
  ...
  [Compatibility Matrix](/docs/resources/compatibility-matrix) for the
...
- [`@nextrush/core`](/docs/reference/core/core) — Application and middleware
- [`@nextrush/router`](/docs/reference/core/router) — Routing
- [`@nextrush/adapter-node`](/docs/reference/adapters/node) — Node.js adapter
- [`@nextrush/errors`](/docs/reference/core/errors) — HTTP errors
