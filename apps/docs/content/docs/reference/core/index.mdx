...
| -------------------------------------------------- | ----------------------------------- | ---------- |
| [`nextrush`](/docs/reference/core/nextrush)         | Meta package with all essentials    | Re-exports |
| [`@nextrush/core`](/docs/reference/core/core)       | Application, middleware composition | ~500 LOC   |
| [`@nextrush/router`](/docs/reference/core/router)   | Segment trie routing                | ~600 LOC   |
| [`@nextrush/types`](/docs/reference/core/types)     | TypeScript type definitions         | ~400 LOC   |
| [`@nextrush/errors`](/docs/reference/core/errors)   | HTTP error classes                  | ~300 LOC   |
| [`@nextrush/runtime`](/docs/reference/core/runtime) | Runtime detection                   | ~400 LOC   |
| [`@nextrush/dev`](/docs/reference/core/dev)         | Development server & build tools    | ~800 LOC   |
...
[`nextrush`](/docs/reference/core/nextrush) bundles the essentials:
...
[`@nextrush/dev`](/docs/reference/core/dev) provides development tooling:
...
<PackageInstall dev={['@nextrush/dev']} packages={[]} />
...
- `Extension` — Extension interface for long-lived, app-scoped services
...
- `Application` class — The container for middleware and extensions
...
- `Router` class — Segment trie router
...
<Cards>
  ...
  <Card title="@nextrush/runtime" href="/docs/reference/core/runtime">
    Runtime detection and abstractions.
  </Card>
  <Card title="@nextrush/dev" href="/docs/reference/core/dev">
