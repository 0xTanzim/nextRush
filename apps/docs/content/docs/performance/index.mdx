...
<div className="my-10 rounded-2xl border border-[var(--color-fd-border)] bg-[color-mix(in_srgb,var(--color-fd-muted)_15%,var(--color-fd-card))] px-5 py-6 shadow-[inset_0_1px_0_0_hsla(220,20%,100%,0.04)] sm:px-7 sm:py-8">
...
<BenchmarkBars
  ...
  items={[
    ...
    },
    {
      ...
      value: 29688,
      detail: '2ms p50, 4ms p99 — segment trie overhead is minimal',
      accent: 'cyan',
    },
    {
      label: 'POST JSON',
...
<div className="my-10 rounded-2xl border border-[var(--color-fd-border)] bg-[var(--color-fd-card)] px-5 py-6 shadow-sm sm:px-7 sm:py-8">
