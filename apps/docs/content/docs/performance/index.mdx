...
<BenchmarkCardGrid
  items={[
    ...
    },
    {
      label: 'Cold start',
      value: 'Host-specific',
      detail: 'Process start time varies by machine, imports, and adapter — measure your deploy target',
    },
    {
      label: 'Core size',
      value: '<3,000 LOC',
...
<BenchmarkBars
  ...
  items={[
    ...
    { label: 'NextRush v3', value: 35370, detail: 'Second by mean RPS in this run.', accent: 'blue' },
