...
<Callout type="info" title="Key takeaways">
  NextRush is **68.5% faster** than Express, **15.9% faster** than Hono, and **18.3% faster** than
  Koa. Fastify is **13.3% faster** than NextRush here (AOT JSON via `fast-json-stringify`).
</Callout>
