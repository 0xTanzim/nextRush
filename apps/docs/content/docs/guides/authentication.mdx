...
- [Database Integration](/docs/guides/database) — Store users in a database
- [Rate Limiting](/docs/reference/middleware/rate-limit) — Protect auth endpoints
- [Class-Based Controllers — Guards](/docs/guides/class-based#guards) — More guard patterns
