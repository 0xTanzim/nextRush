...
A controller with one injected service, wired to the router via `controllersPlugin`:
...
For how the plugin resolves controllers, executes guards, and builds handlers internally, see
