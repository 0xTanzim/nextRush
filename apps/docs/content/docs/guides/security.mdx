...
See [Helmet API Reference](/docs/reference/middleware/helmet) for all options.
...
See [CORS API Reference](/docs/reference/middleware/cors) for all options.
...
See [CSRF API Reference](/docs/reference/middleware/csrf) for the full token lifecycle, session binding, and origin-check options.
...
The recommended approach is [`@nextrush/validation`](/docs/reference/middleware/validation) — it validates against any Standard Schema library and produces a consistent, secure error shape without hand-written conversion code:
...
See the [Authentication guide](/docs/guides/authentication) for JWT implementation.
