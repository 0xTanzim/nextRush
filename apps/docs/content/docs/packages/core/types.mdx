...
<PackageInstall packages={["@nextrush/types"]} dev={true} />
...
interface Plugin {
  ...
  /** Optional cleanup on app.close() */
  destroy?(): void | Promise<void>;
}

interface PluginWithHooks extends Plugin {
  /** Called when app starts */
  onStart?(app: ApplicationLike): void | Promise<void>;
...
```typescript
// Default state is Record<string, unknown>
