...
- [@nextrush/decorators](/docs/packages/di/decorators) — Controller, route, parameter, and guard decorators
- [@nextrush/controllers](/docs/packages/plugins/controllers) — Auto-discovery and handler building with DI
- [DI & Decorators overview](/docs/packages/di) — How DI integrates with the decorator system
