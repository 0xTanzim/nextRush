 ...
 * `apps/website/src/lib/i18n.ts`). This check has no work to do today because
...
// Allow running standalone: `tsx apps/website/scripts/verify/i18n-freshness-check.ts`
