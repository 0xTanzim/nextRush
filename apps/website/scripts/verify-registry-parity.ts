 ...
 * apps/website/src/lib/package-registry.ts. Fails loudly — non-zero exit, a
 ...
 *   tsx apps/website/scripts/verify-registry-parity.ts
 *
 * Exit codes:
...
function main(): void {
  ...
  if (missingFromRegistry.length > 0) {
    console.error(
      `Real packages missing from apps/website/src/lib/package-registry.ts (${missingFromRegistry.length}):`,
    );
