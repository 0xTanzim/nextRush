...
keywords: [class, concepts, dependency, injection, nextrush, runtime]
---
...
<Cards>
  ...
  <Card title="DI internals" href="/docs/architecture/di-internals">
