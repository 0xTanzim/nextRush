...
keywords: [authentication, guides, nextrush]
---
...
<PackageInstall
  packages={['nextrush', '@nextrush/cors', '@nextrush/body-parser', 'jose', 'bcryptjs']}
  dev={['@nextrush/dev', 'typescript', '@types/node', '@types/bcryptjs']}
/>
