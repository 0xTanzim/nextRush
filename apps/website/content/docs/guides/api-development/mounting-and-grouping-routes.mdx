...
keywords: [and, api, development, group, grouping, guides, how, mount, mounting, nextrush, routes]
difficulty: beginner
...
<Mermaid
  chart={`
flowchart TD
  app["Application"] --> api["api router\\n(mount /api/v1)"]
  api --> users["users router\\n(mount /users)"]
  api --> posts["posts router\\n(mount /posts)"]
  api --> admin["admin routes\\n(group /admin + auth)"]
  style app fill:#F16913,stroke:#C5530E,color:#fff
