...
keywords: [api, apis, building, development, guides, nextrush, rest]
---
...
<Callout type="info" title="Typed error classes">
  ...
  above — no manual try/catch needed. See [Error Handling](/docs/guides/api-development/error-handling) for the
...
<Cards>
  ...
  />
  <Card title="Testing" description="Test your API endpoints." href="/docs/guides/testing/testing" />
  <Card
    title="Security"
