...
keywords: [api, custom, development, guides, middleware, nextrush]
---
...
- A working NextRush application ([Task API Tutorial](/docs/getting-started/quick-start))
...
```typescript
import type { Context, Middleware, Next } from 'nextrush';
...
```typescript
import type { Middleware } from 'nextrush';
import { NotFoundError, ConflictError } from 'nextrush';
...
import type { Context, Next } from 'nextrush';
