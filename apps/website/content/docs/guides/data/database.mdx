...
keywords: [data, database, guides, integration, nextrush]
---
...
- [Class-Based Controllers](/docs/guides/api-development/class-based) — Full class-based example
- [Authentication](/docs/guides/authentication/authentication) — Add user authentication
- [Testing Guide](/docs/guides/testing/testing) — Test database code
