...
keywords: [deployment, edge, nextrush, production]
---
...
<TypeTable
  ...
  types={{
    ...
    timeout: { type: 'number', description: 'Request timeout in ms. Races the handler and returns 504 on expiry. Defaults to 24000 (DEFAULT_EDGE_TIMEOUT_MS); pass 0 to disable.', optional: true },
  }}
/>
