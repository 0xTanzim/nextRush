...
keywords: [edge, getting, nextrush, runtime, started]
difficulty: beginner
...
<RuntimeSupport
  ...
  links={{ node: '/docs/getting-started/runtime/node', bun: '/docs/getting-started/runtime/bun', deno: '/docs/getting-started/runtime/deno', serverless: '/docs/getting-started/runtime/serverless' }}
/>
...
<Cards>
  ...
  <Card title="Try serverless next" href="/docs/getting-started/runtime/serverless">
