...
keywords: [architecture, hierarchy, nextrush, package]
---
...
<Callout type="info" title="This graph is generated, not hand-drawn">
  ...
  [`apps/website/scripts/internals/generate-dependency-graph.mjs`](https://github.com/0xTanzim/nextRush/blob/main/apps/website/scripts/internals/generate-dependency-graph.mjs),
...
- **@nextrush/cookies** `1.0.0` → @nextrush/errors, @nextrush/runtime, @nextrush/types
