...
keywords: [nextrush, reference, validation]
---
...
<Callout type="info" title="Source & internals">
  [README](https://github.com/0xTanzim/nextRush/blob/main/packages/middleware/validation/README.md) ·
  [ARCHITECTURE](https://github.com/0xTanzim/nextRush/blob/main/packages/middleware/validation/ARCHITECTURE.md)
</Callout>
...
- **Body parsing** — that is [`@nextrush/body-parser`](/docs/reference/body-parser)'s job.
- **Response validation** — planned alongside `@nextrush/openapi`.

## Related

- [`@nextrush/openapi`](/docs/reference/openapi) — reads the schemas this middleware contributes to route metadata and renders them as a spec
- [`@nextrush/body-parser`](/docs/reference/body-parser) — populates `ctx.body` before validation runs
- [Validation Guide](/docs/guides/api-development/validation) — task-oriented walkthrough with more examples
