...
keywords: [adapters, index, nextrush, platforms, reference, runtime]
---
...
| [`@nextrush/adapter-bun`](/docs/reference/platforms/bun)   | Bun                       | Yes                    |
| [`@nextrush/adapter-deno`](/docs/reference/platforms/deno) | Deno                      | Yes                    |
| [`@nextrush/adapter-edge`](/docs/reference/platforms/edge) | Edge (Cloudflare, Vercel) | Yes                    |
| [`@nextrush/adapter-nextjs`](/docs/reference/platforms/nextjs) | Next.js App Router (any host Next.js runs on) | Yes |
...
<Cards>
  <Card title="@nextrush/adapter-node" href="/docs/reference/platforms/node">
  ...
  <Card title="@nextrush/adapter-deno" href="/docs/reference/platforms/deno">
