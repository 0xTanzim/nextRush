...
keywords: [next.js, nextjs, nextrush, platforms, reference]
---
...
the [Next.js tutorial](/docs/getting-started/frameworks/nextjs).
...
the [Next.js tutorial](/docs/getting-started/frameworks/nextjs) for the full, runnable version of this
example:
...
<Callout type="warn" title="Requires enabling legacy decorators in tsconfig.json">
  ...
  14/15/16) — see the [tutorial's full caveat](/docs/getting-started/frameworks/nextjs) before relying on it.
</Callout>
...
- [Next.js tutorial](/docs/getting-started/frameworks/nextjs) — the full walkthrough: installation, project
