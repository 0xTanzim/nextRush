...
keywords: [core, nextrush, reference, routing, runtime]
---
...
<Callout type="info" title="Source & internals">
  [README](https://github.com/0xTanzim/nextRush/blob/main/packages/runtime/README.md) ·
  [ARCHITECTURE](https://github.com/0xTanzim/nextRush/blob/main/packages/runtime/ARCHITECTURE.md)
</Callout>
...
<TypeTable
  ...
  types={{
    ...
    capabilities: {
      ...
      description: 'Feature support flags for the detected runtime',
    },
  }}
/>

<details>
<summary>Example RuntimeInfo output</summary>
...
Multi-value headers are stored as `string[]`. The result exposes no inherited `Object.prototype`
members, so a header name like `__proto__` or `constructor` can never resolve to one — see
[ADR-0021](https://github.com/0xTanzim/nextRush/blob/main/docs/adr/ADR-0021-fast-property-request-containers.md)
for why the container derives from a shared null-prototype base rather than being built with
`Object.create(null)` directly.
...
<Cards>
  <Card title="Adapters" href="/docs/reference/platforms">
    Runtime adapters use this package internally.
  </Card>
  <Card title="@nextrush/types" href="/docs/reference/types">
    Runtime type definitions.
  </Card>
  <Card title="@nextrush/body-parser" href="/docs/reference/body-parser">
