...
keywords: [api, docs, nextrush, openapi, reference]
---

## Why This Package Exists

<Callout type="info" title="Source & internals">
  [README](https://github.com/0xTanzim/nextRush/blob/main/packages/middleware/openapi/README.md) ·
  [ARCHITECTURE](https://github.com/0xTanzim/nextRush/blob/main/packages/middleware/openapi/ARCHITECTURE.md)
</Callout>
