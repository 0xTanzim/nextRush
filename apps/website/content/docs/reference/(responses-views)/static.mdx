...
keywords: [nextrush, reference, responses, static, views]
---
...
<Callout type="info" title="Source & internals">
  [README](https://github.com/0xTanzim/nextRush/blob/main/packages/middleware/static/README.md) ·
  [ARCHITECTURE](https://github.com/0xTanzim/nextRush/blob/main/packages/middleware/static/ARCHITECTURE.md)
</Callout>
...
`@nextrush/core` is an *optional* peer dependency (for the `Context`/`Middleware` type contracts) — not installed automatically.
