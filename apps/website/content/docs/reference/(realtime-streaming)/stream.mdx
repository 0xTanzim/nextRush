...
keywords: [nextrush, realtime, reference, stream, streaming]
---

## Why This Package Exists

<Callout type="info" title="Source & internals">
  [README](https://github.com/0xTanzim/nextRush/blob/main/packages/stream/README.md) ·
  [ARCHITECTURE](https://github.com/0xTanzim/nextRush/blob/main/packages/stream/ARCHITECTURE.md)
</Callout>
...
- [`@nextrush/openapi`](/docs/reference/openapi) — documents regular JSON routes; streaming routes are not represented in OpenAPI (no schema for a token stream)
