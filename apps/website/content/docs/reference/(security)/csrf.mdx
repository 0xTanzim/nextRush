...
keywords: [csrf, nextrush, reference, security]
---

## Why CSRF Protection Exists

<Callout type="info" title="Source & internals">
  [README](https://github.com/0xTanzim/nextRush/blob/main/packages/middleware/csrf/README.md) ·
  [ARCHITECTURE](https://github.com/0xTanzim/nextRush/blob/main/packages/middleware/csrf/ARCHITECTURE.md)
</Callout>
