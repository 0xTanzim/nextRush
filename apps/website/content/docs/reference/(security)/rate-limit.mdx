...
keywords: [limit, nextrush, rate, reference, security]
---
...
<Callout type="info" title="Source & internals">
  [README](https://github.com/0xTanzim/nextRush/blob/main/packages/middleware/rate-limit/README.md) ·
  [ARCHITECTURE](https://github.com/0xTanzim/nextRush/blob/main/packages/middleware/rate-limit/ARCHITECTURE.md)
</Callout>
