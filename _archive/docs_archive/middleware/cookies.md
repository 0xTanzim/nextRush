...
│ 2. Sanitize values (remove CRLF)     │
│ 3. Store in ctx.state.cookies        │
├──────────────────────────────────────┤
│       Your Handler Runs              │
│ - Read: ctx.state.cookies.get()      │
│ - Write: ctx.state.cookies.set()     │
├──────────────────────────────────────┤
│ 4. Serialize queued cookies          │
│ 5. Validate prefixes & options       │
│ 6. Set Set-Cookie headers            │
└──────────────────────────────────────┘
       │
       ▼
