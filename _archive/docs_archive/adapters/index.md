...
Your Application Code
         ...
         ▼
┌─────────────────────┐
│   NextRush Core     │  ← Same API everywhere
│   (ctx.json, etc.)  │
└─────────────────────┘
         │
         ▼
┌─────────────────────┐
│      Adapters       │  ← Platform-specific bridges
├─────────────────────┤
│ ● adapter-node      │  Node.js (IncomingMessage)
│ ● adapter-bun       │  Bun (Bun.serve)
│ ● adapter-deno      │  Deno (Deno.serve)
│ ● adapter-edge      │  Edge (fetch handler)
└─────────────────────┘
         │
         ▼
   Platform HTTP APIs
