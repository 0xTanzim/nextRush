/**
 * @nextrush/adapter-bun - Body Source
 *
 * The bespoke `BunBodySource`/`EmptyBodySource`/`concatUint8Arrays` have been
 ...
 * major version.
 */
export const BunBodySource = WebBodySource;
export type BunBodySource = WebBodySource;

/**
 * @deprecated Use {@link createWebBodySource} from `@nextrush/runtime`.
 */
export const createBunBodySource = createWebBodySource;
