...
Reference: `docs/RFC/class-runtime/008-request-scope.md`.
...
**Known limitation**: modules group but do **not** yet encapsulate — every provider is visible to every module via the shared DI container regardless of `exports`. True per-module encapsulation is planned follow-up (`docs/RFC/class-runtime/012-modules.md`).
